...
func TestTranslate(t *testing.T) {
	for tn, tc := range map[string]struct {
			...
			want: []TargetDescriptor{
				{
					...
					Labels: map[string]string{
						...
						"__meta_tailscale_device_online":         "true",
		...
		"single offline device without tags expands to single descriptor": {
			devices: []Device{
				{
					Addresses: []string{
						"100.2.3.4",
			...
			want: []TargetDescriptor{
				{
					...
					Labels: map[string]string{
						...
						"__meta_tailscale_device_id":             "id",
						"__meta_tailscale_device_name":           "somethingclever",
						"__meta_tailscale_device_online":         "false",
						"__meta_tailscale_device_os":             "beos",
						"__meta_tailscale_tailnet":               "-",
					},
				},
	...
	for tn, tc := range map[string]struct {
		...
		"stale results are still served": {
			...
			want: httpWant{
				...
				body:        `[{"targets":["100.2.3.4","fd7a::1234"],"labels":{"__meta_tailscale_api":"foo.example.com","__meta_tailscale_device_authorized":"false","__meta_tailscale_device_client_version":"420.69","__meta_tailscale_device_hostname":"somethingclever","__meta_tailscale_device_id":"id","__meta_tailscale_device_name":"somethingclever","__meta_tailscale_device_online":"true","__meta_tailscale_device_os":"beos","__meta_tailscale_device_tag_bar":"1","__meta_tailscale_device_tag_foo":"1","__meta_tailscale_tailnet":"-"}}]` + "\n",
			},
		},
